...
<b>:package:[Dense Pose Transfer](https://arxiv.org/pdf/1809.01995.pdf) (Sep 2018)
...
<b>:movie_camera::one::package: [VNect: Real-time 3D Human Pose Estimation with a Single RGB Camera](http://gvv.mpi-inf.mpg.de/projects/VNect/content/VNect_SIGGRAPH2017.pdf) (July 2017)</b> [[Project]](http://gvv.mpi-inf.mpg.de/projects/VNect/)

<b>:camera::one::package: [Monocular 3D Human Pose Estimation In The Wild Using Improved CNN Supervision](https://arxiv.org/pdf/1611.09813.pdf) (Oct 2017)</b> [[Project]](http://gvv.mpi-inf.mpg.de/3dhp-dataset/)
...
<b>:movie_camera::one::package: [Sparseness Meets Deepness: 3D Human Pose Estimation from Monocular Video](https://arxiv.org/pdf/1511.09439.pdf) (Apr 2016)</b> [[Project]](http://cis.upenn.edu/~xiaowz/monocap.html)
...
:package:[A Simple Yet Effective Baseline for 3d Human Pose Estimation](https://arxiv.org/pdf/1705.03098.pdf) (Aug 2017)

:package:[Compositional Human Pose Regression](https://arxiv.org/pdf/1704.00159.pdf) (Aug 2017)
...
:door:[Knowledge-Guided Deep Fractal Neural Networks for Human Pose Estimation](https://arxiv.org/pdf/1705.02407.pdf) [[CODE]](https://github.com/Guanghan/GNet-pose) (Aug 2017)

:package:[VNect: Real-time 3D Human Pose Estimation with a Single RGB Camera](http://gvv.mpi-inf.mpg.de/projects/VNect/content/VNect_SIGGRAPH2017.pdf) [[CODE]](https://github.com/timctho/VNect-tensorflow) (Jul 2017)
...
:package:[Monocular 3D Human Pose Estimation In The Wild Using Improved CNN Supervision](http://gvv.mpi-inf.mpg.de/3dhp-dataset/) (Nov 2016)
